...
drop _merge
erase data/gdpdata.dta
erase data/ctax_CTI.dta
merge 1:1 ID year using data/emission2018
drop _merge
erase data/emission2018.dta
merge 1:1 ID year using data/employment
drop _merge
erase data/employment.dta
sort country year
*
...
*
save data/analysis/ctax_AEJM,replace
