...
import excel using "C:\Users\matti\OneDrive\Desktop\uni\thesis\5. Mattia fa cose\Raw data\sicuri\OECD_GDP_mio.xlsx",sheet(US gdp deflator (FRED)) case(lower) first clear 
...
import excel using "C:\Users\matti\OneDrive\Desktop\uni\thesis\5. Mattia fa cose\Raw data\sicuri\OECD_GDP_mio.xlsx",sheet(OECD ppp) case(lower) first clear 
...
import excel using "C:\Users\matti\OneDrive\Desktop\uni\thesis\5. Mattia fa cose\Raw data\sicuri\OECD_GDP_mio.xlsx",sheet(GDP constant LCU) cellrange(A4:BO270) first clear
...
import excel using "C:\Users\matti\OneDrive\Desktop\uni\thesis\5. Mattia fa cose\Raw data\sicuri\OECD_GDP_mio.xlsx",sheet(GDP deflator) cellrange(A4:BP270) first clear
drop CountryName IndicatorName IndicatorCode
reshape long _, i(CountryCode) j(year)
...
import excel using "C:\Users\matti\OneDrive\Desktop\uni\thesis\5. Mattia fa cose\Raw data\sicuri\OECD_GDP_mio.xlsx",sheet(OECD nominal gdp in USD (OECD)) case(lower) first clear 
keep location time value
rename location ID
rename time year
...
import excel using "C:\Users\matti\OneDrive\Desktop\uni\thesis\5. Mattia fa cose\Raw data\sicuri\OECD_GDP_mio.xlsx",sheet(OECD nominal gdppc in USD(OECD)) case(lower) first clear 
keep location time value
rename location ID
rename time year
...
import excel using "C:\Users\matti\OneDrive\Desktop\uni\thesis\5. Mattia fa cose\Raw data\sicuri\Irish Modified GNI.xlsx",sheet(data) case(lower) first clear 
...
import excel using "C:\Users\matti\OneDrive\Desktop\uni\thesis\5. Mattia fa cose\Raw data\sicuri\Norway_mainland_right.xlsx",sheet(tostata) case(lower) first clear 
